...
public class InquilinoDTO {
    ...
    private Boolean estaAlquilando;
    ...
    public Boolean getEstaAlquilando() {
        return estaAlquilando;
    }

    public void setEstaAlquilando(Boolean estaAlquilando) {
        this.estaAlquilando = estaAlquilando;
    }
